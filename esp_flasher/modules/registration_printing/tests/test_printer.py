"""Tests for registration_printing module: printer factory."""
import sys
...
class TestGetPrinter:
    ...
    @patch("esp_flasher.modules.registration_printing.printer.platform.system", return_value="Linux")
    @patch("esp_flasher.modules.registration_printing.printer.BrotherQLPrinter")
    ...
    @patch("esp_flasher.modules.registration_printing.printer.platform.system", return_value="Windows")
    def test_windows_returns_windows_printer(self, mock_system):
        ...
        with patch.dict(sys.modules, {
            ...
            sys.modules.pop("esp_flasher.modules.registration_printing.printers.win_printer", None)
    ...
    @patch("esp_flasher.modules.registration_printing.printer.platform.system", return_value="Darwin")
