"""Tests for registration_printing module: printer_utils."""
...
class TestListAvailablePrinters:
    ...
    @patch("esp_flasher.modules.registration_printing.printer_utils.platform.system", return_value="Linux")
    ...
    @patch("esp_flasher.modules.registration_printing.printer_utils.platform.system", return_value="Darwin")
